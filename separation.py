...
if __name__ == '__main__':
    ...
    network_file = '\\'.join(os.path.abspath(__file__).split('\\')[:-1]) + '\\interactome.tsv'
    gene_file_1  = '\\'.join(os.path.abspath(__file__).split('\\')[:-1]) + '\\MS.txt'
    gene_file_2  = '\\'.join(os.path.abspath(__file__).split('\\')[:-1]) + '\\PD.txt'
